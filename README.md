...
### Данные
Рассматриваются четыре типа интерфейсов:
+ Товар (id, название, изображение, категория, цена, описание).
+ Покупатель (платежное средство, адрес, почта, телефон).
+ Каталог на главной (массив товаров, выбранная карточка).
+ Корзина с товарами (массив товаров).
...
### Слой коммуникации
Класс, использующий композицию для выполнения запроса следующими методами:
+ get. Получение данных с сервера.
+ post. Отправка данных о покупателе на сервер.